...
def create_parser():
    ...
    parser.add_argument('--exp_name', '-exp', default='stylegan_celeba_vgg16_taa', help='')
...
def attack_single_id(targetnets, z, G, D, evaluation_model, targets_single_id):
    ...
    if os.path.exists(final_z_unselected_path):
        ...
        for i in range(math.ceil(z.shape[0] / batch_size)):
            ...
            z_batch_optimized = optimization.gmi_optimize_taa(i ,z_batch, targets_batch, num_iterations)
