...
from datasets.celeba import CelebA1000, CelebA100
...
class TrainingConfigParser:
    ...
    def create_datasets(self):
        ...
        if name == 'facescrub':
            ...
            test_set = CelebA1000(train=False,
                                  transform=data_transformation_test)
        elif name == 'celeba_identities100':
            train_set = CelebA100(train=True)
            test_set = CelebA100(train=False,
                                  transform=data_transformation_test)
        ...
        train_set = Subset(train_set, train_idx, data_transformation_test) # <---- attention here
    ...
    def create_transformations(self, mode, normalize=False):
        """
